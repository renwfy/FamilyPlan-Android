 ...
 */
public class FragmentMyAdapter extends SimpleAdapter<String> {
    public FragmentMyAdapter(Context context, List<String> data) {
        super(context, data);
    }
    ...
    public View getView(int position, String data, View convertView) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.view_my_item, null);
        }
