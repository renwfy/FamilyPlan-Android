...
public class PickConfig {
    ...
    public final static String EXTRA_START_WITH_CAMERA = "extra_start_with_camera";
    ...
    public final static String EXTRA_ASPECTRATIO_X = "extra_aspectratio_x";
    public final static String EXTRA_ASPECTRATIO_Y = "extra_aspectratio_y";
    ...
    private PickConfig(Activity context, PickConfig.Builder builder) {
        ...
        this.startwithcamera = builder.start_with_camera;
        ...
        bundle.putBoolean(EXTRA_START_WITH_CAMERA, this.startwithcamera);
        bundle.putBoolean(EXTRA_IS_NEED_CROP, this.isneedcrop);
        bundle.putBoolean(EXTRA_IS_SQUARE_CROP,this.isSqureCrop);
        bundle.putInt(EXTRA_ASPECTRATIO_X,this.ratioX);
        bundle.putInt(EXTRA_ASPECTRATIO_Y,this.ratioY);
    ...
    public static class Builder {
        ...
        private boolean start_with_camera = false;
        ...
        public PickConfig.Builder setAspectRatio(int ratioX,int ratioY) {
            this.ratioX = ratioX;
            this.ratioY = ratioY;
            return this;
        }
        ...
        public PickConfig.Builder startwithcamera(boolean start_with_camera) {
            this.start_with_camera = start_with_camera;
            return this;
        }
